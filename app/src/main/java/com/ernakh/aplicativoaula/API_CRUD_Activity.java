...
public class API_CRUD_Activity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_api_crud);
...
* new Thread(() -> {
    try {
        ...
        postAtualizado.setTitle("Novo Título Atualizado");
        postAtualizado.setBody("Novo Corpo Atualizado");

        Gson gson = new Gson();
        String jsonPost = gson.toJson(postAtualizado);
        ...
        int responseCode = conexao.getResponseCode();
        runOnUiThread(() -> txtResultado.setText("PUT Código de resposta: " + responseCode));
...
*new Thread(() -> {
    try {
        ...
        int responseCode = conexao.getResponseCode();
        runOnUiThread(() -> txtResultado.setText("DELETE Código de resposta: " + responseCode));
